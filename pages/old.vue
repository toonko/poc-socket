<template>
  <div>
    <div id='buttons'>
      <button class='btn-main-color m-10' id='cameraBtn' @click='openUserMedia'>Open camera & microphone</button>
      <button class='btn-main-color m-10' id='screenBtn' @click='openUserMediaScreen'>Open user screen</button>
      <button class='btn-main-color m-10' disabled id='createBtn' @click='createRoom'>Create room</button>
      <!-- <button class='btn-main-color m-10' disabled id='joinBtn'>Join room</button> -->
      <button class='btn-main-color m-10' disabled id='hangupBtn' @click='hangUp'>Hangup</button>
    </div>
    <div>
      <span id='currentRoom'></span>
      <input v-model='roomIdInput' placeholder='room id'/>
      <button class='btn-main-color m-10' id='confirmJoinBtn' @click='joinRoom'>Join</button>
    </div>
    <div class='d-flex'>
      <div id='videos' class='p-3 flex-fill'>
        <!-- <div>remoteVideo</div> -->
        <video id='remoteVideo' class='w-100' playsinline autoplay controls></video>
        <!-- <div>localVideo</div> -->
        <video id='localVideo' muted autoplay playsinline style="width:250px; height:250px;"></video>
    ...
    <!-- <div id="message"></div>
    <button id="record" @click="startRecord"> start record</button>
    <button @click="stopRecord">stop record</button> -->
    <!-- <div>outputVideo</div> -->
    <!-- <video id='outputVideo' autoplay playsinline style="width:50px; height:50px;"></video> -->
  </div>
</template>
