<template lang="pug">
  div 
    #buttons 
      button#cameraBtn.m-3(@click='openUserMedia') Open camera & microphone
      button#screenBtn.m-3(@click='openUserMediaScreen') Share screen
      button#createBtn.m-3(@click='createBtn' disabled) Create room
      button#hangupBtn.m-3(@click='hangUp' disabled) Hangup

    .detail 
      .detail__title Current Room 
      .detail__room.w-50
